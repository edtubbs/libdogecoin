...
test_negative_paths() {
    ...
    rm -f "${WORKDIR}/encrypted_seed_777"
    ...
    rm -f "${WORKDIR}/encrypted_hdnode_888"
...
main() {
    ...
    # All TPM-encrypted blobs (encrypted_seed_N / encrypted_mnemonic_N /
    # encrypted_hdnode_N) are written to the current working directory,
    # so isolate them inside WORKDIR.
    cd "$WORKDIR"
