...
get_testnet_coins() {
    ...
    echo ""
    echo "Faucets:"
    echo "  1. https://faucet.dogetest.doge.xyz/"
    echo "  2. https://faucet.doge.toys/ (currently includes reCAPTCHA markup)"
    echo "  3. https://faucet.triangleplatform.com/dogecoin/testnet (currently includes reCAPTCHA markup)"
    echo "  4. https://dogecoin-faucet.ruan.dev/"
    echo "  5. Discord: Dogecoin community #testnet channel"
    echo "  6. Reddit: r/dogecoindev"
    echo ""
    echo "Note: faucets may rate-limit by IP and some currently include browser CAPTCHA."
    echo ""
    echo "[FAUCET] Preferred: https://faucet.dogetest.doge.xyz/"
