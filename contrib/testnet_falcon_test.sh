...
get_testnet_coins() {
    ...
    echo ""
    echo "Faucets:"
    echo "  1. https://faucet.dogetest.doge.xyz/ (preferred for end-to-end runs; currently no CAPTCHA markup detected)"
    ...
    echo ""
    echo "Note: faucets may rate-limit by IP and fallback options may currently require browser CAPTCHA."
    echo ""
