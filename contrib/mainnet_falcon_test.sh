...
FUNDED_UTXO_TXID="${FUNDED_UTXO_TXID:-${CHAINED_UTXO_TXID:-e7793c5a133ea80e8302f7df547b8f2bf095de346f4196fbb134c7269720b7d8}}"
...
TX_R_FEE_KOINU="${TX_R_FEE_KOINU:-100000}"
