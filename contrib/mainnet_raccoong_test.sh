...
# Raccoon-G needs 24 carrier outputs; default to 1 DOGE (100000000 koinu) each = 24 DOGE total
CARRIER_VALUE_KOINU="${CARRIER_VALUE_KOINU:-100000000}"
# Minimum 100000000 koinu (1 DOGE) per carrier to avoid dust and ensure adequate TX_R fee headroom
