...
TX_R_FEE_KOINU="${TX_R_FEE_KOINU:-20000000}"
# Raccoon-G needs 24 carrier outputs; default to 0.1 DOGE (10000000 koinu) each = 2.4 DOGE total
CARRIER_VALUE_KOINU="${CARRIER_VALUE_KOINU:-10000000}"
# Minimum 1000000 koinu (0.01 DOGE) per carrier to avoid dust
if [ "$CARRIER_VALUE_KOINU" -lt 1000000 ]; then
    CARRIER_VALUE_KOINU=1000000
fi
