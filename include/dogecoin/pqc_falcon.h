/*
 * Falcon-512 prototype helpers for libdogecoin.
 * Optional: build with -DUSE_LIBOQS and link against liboqs.
 */
...
/*
 * Convenience wrapper returning a 32-byte SIGHASH for an input.
 */
