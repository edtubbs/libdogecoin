...
/* default file to use for TPM storage */
#define DEFAULT_FILE 0

/* number of files (per object type) to use for TPM storage */
...
LIBDOGECOIN_API dogecoin_bool dogecoin_generate_hdnode_encrypt_with_tpm(dogecoin_hdnode* out, const int file, const dogecoin_bool overwrite);
